#
# cix-hosttools -- ADR-0078: every real binary cixd itself shells
...
# machine happens to run mkbootroot. See docs/guides/building-cix.md's
...
# 192.168.15.95's own real, organic `pkg install --image=cix-hosttools`
