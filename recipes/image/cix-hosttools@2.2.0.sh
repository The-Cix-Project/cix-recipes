...
#
image_packages="glibc:pinned:2.44-14 bash:pinned:5.2.37-5 btrfs-progs:pinned:7.1-10 bzip2:pinned:1.0.8-4 coreutils:pinned:9.11-7 curl:pinned:8.21.0-4 gzip:pinned:1.13-4 openssl:pinned:3.0.20-5 perl:pinned:5.40.1-7 squashfs-tools:pinned:4.7.5-12 tar:pinned:1.35-6 xz:pinned:5.8.3-8 zlib:pinned:1.3.2-10"
