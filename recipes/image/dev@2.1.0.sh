#
# 2.1.0: libc-dev -> glibc (#187, ADR-0217). Same job, different
...
#
image_packages="bash:pinned:5.2.37 bc:pinned:1.08.1 binutils:pinned:2.42-7 bison:pinned:3.8.2-2 bzip2:pinned:1.0.8 coreutils:pinned:9.11-3 elfutils:pinned:0.192-6 flex:pinned:2.6.4-2 gawk:pinned:5.3.0-2 grep:pinned:3.11-2 glibc:pinned:2.44-12 m4:pinned:1.4.19 make:pinned:4.4.1 sed:pinned:4.9-2 tar:pinned:1.35-5 tcc:pinned:0.9.27 xz:pinned:5.8.3-2 zlib:pinned:1.3.2-3"
