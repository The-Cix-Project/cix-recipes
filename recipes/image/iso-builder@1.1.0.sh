...
image_packages="autoconf:pinned:2.71-2 automake:pinned:1.16.5-2 bash:pinned:5.2.37-2 binutils:pinned:2.42-8 binutils-dev:pinned:2.42-3 bison:pinned:3.8.2-2 coreutils:pinned:9.11-3 diffutils:pinned:3.10-6 flex:pinned:2.6.4-4 gawk:pinned:5.3.0-7 gcc:pinned:16.2.0-11 getopt:pinned:2.42.2-2 gnu-efi:pinned:3.0.18-4 grep:pinned:3.11-4 grub:pinned:2.14-6 gzip:pinned:1.13-3 libc-dev:pinned:2.36-8 libuuid:pinned:2.42.2 m4:pinned:1.4.19-2 make:pinned:4.4.1-4 mtools:pinned:4.0.49-2 openssl:pinned:3.0.20-2 patch:pinned:2.8-3 perl:pinned:5.40.1 python:pinned:3.13.5-4 sbsigntools:pinned:0.9.5-9 tar:pinned:1.35-5 xorriso:pinned:1.5.8.pl02-3 zlib:pinned:1.3.2-6"
