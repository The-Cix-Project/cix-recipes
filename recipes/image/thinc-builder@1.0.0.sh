#
# thinc-builder -- the toolchain image thinc.recipe's own self-hosted
...
# openssl (thincd itself links -lssl -lcrypto, ADR-0059), and perl
# (a real build-time dependency of some of this set's own recipes).
# See docs/guides/building-thinc.md's own "1. Build a toolchain image"
# section for the full narrative. Captured live from 192.168.15.95's
# own real, organic `pkg install --image=thinc-builder` history
