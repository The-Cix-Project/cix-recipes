...
pkg_toolchain="gcc"
pkg_toolchain_reason="missing language feature: needs __builtin_ms_va_list for the EFI calling convention, which TCC does not implement; bfd.c also fails to parse"
pkg_build_depends="bash coreutils make gcc linux-headers sed grep gawk binutils findutils"
pkg_changelog="2.42-5: declare pkg_toolchain=gcc and its reason (#222, ADR-0226)"
