...
pkg_toolchain="gcc"
pkg_toolchain_reason="codegen/parse: bfd.c and friends fail to parse under TCC: \"';' expected (got \\"bfd_error_type\\")\""
pkg_build_depends="gcc make linux-headers bash coreutils sed grep gawk binutils zlib flex"
pkg_changelog="2.42-11: declare pkg_toolchain=gcc and its reason (#222, ADR-0226)"
