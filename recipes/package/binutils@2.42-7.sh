...
# With it set, an install fetches <artifact base_url>/binutils-2.42-7.tar.gz
# and verifies it against this checksum instead of building from
# source; without it the artifact tier is skipped entirely.
# The checksum lives here, in git, because the artifact server is
# never a trust boundary -- it serves bytes, this line approves them.
pkg_artifact_sha256="ed300516eb531e7247792e251adaf3a8a538dc71f7e2ea9483372c4633844ebe"
...
pkg_build() {
	mkdir -p build
	cd build
	CC=tcc CFLAGS="-g -O2 -DTLS=" LDFLAGS="-lm" ../configure --prefix=/usr \
