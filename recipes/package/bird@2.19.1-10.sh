...
#
pkg_toolchain="gcc"
pkg_toolchain_reason="compiler identity check: configure rejects tcc by name, so no capability can satisfy it"
...
pkg_changelog="2.19.1-10: declare pkg_toolchain=gcc and its reason (#222, ADR-0226)"
