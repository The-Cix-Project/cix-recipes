...
pkg_changelog="3.8.2-6: works around the gnulib/glibc-2.44 posix_spawn_file_actions_addchdir clash, same as m4. 3.8.2-3: declares its build tools so it can be rebuilt through the ordinary install path (#206)"
#
# Build tools derived rather than guessed: the baseline the declaring
# recipes converge on, plus what this recipe's own pkg_build() invokes
# and the libraries it already declares. See
