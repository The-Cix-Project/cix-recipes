...
pkg_name="cix"
pkg_version="v1.4.0"
pkg_source="https://osakka:REPLACE_WITH_REAL_TOKEN@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v1.4.0.tar.gz"
...
pkg_build() {
	make build/cixd build/cixctl build/mkbootroot build/cix-install build/mkinstalleriso
}

pkg_install() {
	cp build/cixd build/cixctl build/mkbootroot build/cix-install build/mkinstalleriso \
	   "$PKG_DESTDIR/"
