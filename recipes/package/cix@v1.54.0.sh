...
# cix-hosttools image for the first time ever) found and fixed a
...
pkg_name="cix"
pkg_version="v1.54.0"
pkg_source="https://osakka:REPLACE_WITH_REAL_TOKEN@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v1.54.0.tar.gz"
