...
pkg_name="cix"
pkg_version="v2.0.1"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.0.1.tar.gz"
pkg_sha256="f17688ae6b3ac9f4ccb8fc2058deb7ac5751b91b9bc9c9aab81e2f2c2e3d1bed"
pkg_depends=""
