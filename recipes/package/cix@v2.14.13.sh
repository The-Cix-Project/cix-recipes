#
# v2.14.13 -- a btrfs partition can be grown (#163), which needed btrfs-progs
...
#
pkg_name="cix"
pkg_version="v2.14.13"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.14.13.tar.gz"
pkg_sha256="72ee767193c43a111ad08f7b2da46ad70e452167af458dd5bd2ced1fcd5e5845"
