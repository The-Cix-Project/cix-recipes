#
# v2.14.16 -- a btrfs partition can be grown (#163), which needed btrfs-progs
...
#
pkg_name="cix"
pkg_version="v2.14.16"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.14.16.tar.gz"
pkg_sha256="2b81771056bf622d04367c376180eb89f56ae7497150c3a3f4fc4039433137bb"
