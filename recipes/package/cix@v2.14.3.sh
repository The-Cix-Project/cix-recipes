#
# v2.14.3 -- a client that stops reading can no longer freeze the daemon
...
pkg_name="cix"
pkg_version="v2.14.3"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.14.3.tar.gz"
pkg_sha256="b13efd102b6e532f5672d096343cccef78341cf4c57c03fef8325dd97f2cb2fd"
