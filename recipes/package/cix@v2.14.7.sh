#
# v2.14.7 -- a btrfs partition can be grown (#163), which needed btrfs-progs
...
pkg_name="cix"
pkg_version="v2.14.7"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.14.7.tar.gz"
pkg_sha256="581a7222b6974f0f11f904b7776d1e8c8661b66339895cd82542e0b0ac48c929"
