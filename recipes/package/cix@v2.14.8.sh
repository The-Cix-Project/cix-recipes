#
# v2.14.8 -- a btrfs partition can be grown (#163), which needed btrfs-progs
...
pkg_name="cix"
pkg_version="v2.14.8"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.14.8.tar.gz"
pkg_sha256="548d86895066ff7e9ec4de6b5cb25b6e0b1387eccb12479c4e313e3051963502"
