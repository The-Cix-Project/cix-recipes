#
# v2.15.0 -- a btrfs partition can be grown (#163), which needed btrfs-progs
...
pkg_name="cix"
pkg_version="v2.15.0"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.15.0.tar.gz"
pkg_sha256="3dbc8883ef946750e338337b4d5a97e2241718ea935319a597709fa6ea422666"
