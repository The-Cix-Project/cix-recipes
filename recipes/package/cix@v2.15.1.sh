#
# v2.15.1 -- a btrfs partition can be grown (#163), which needed btrfs-progs
...
pkg_name="cix"
pkg_version="v2.15.1"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.15.1.tar.gz"
pkg_sha256="18c07103fcab2f6c3f4cce6837ccc41e8e5c1c204d9d4d074b4a88dc58ee40ef"
