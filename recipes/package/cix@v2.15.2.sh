#
# v2.15.2 -- a btrfs partition can be grown (#163), which needed btrfs-progs
...
pkg_name="cix"
pkg_version="v2.15.2"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.15.2.tar.gz"
pkg_sha256="b2d1bc6601f7e2948aac0f60f17a0d1f85be3ee53ac498da3133d1db829935f2"
