#
# v2.15.3 -- a btrfs partition can be grown (#163), which needed btrfs-progs
...
pkg_name="cix"
pkg_version="v2.15.3"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.15.3.tar.gz"
pkg_sha256="cfc9c58653f10656f83073dcdc251c22e9a6c52b452ee04b7ccaa7ccb42f0248"
