...
#
pkg_name="cix"
pkg_version="v2.2.0-rc28"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.2.0-rc28.tar.gz"
pkg_sha256="a536b33649ed4db801559a5a17a074ed99717b79908cdcfcdedbc07080662fbe"
