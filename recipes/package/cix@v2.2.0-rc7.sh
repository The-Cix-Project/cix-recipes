...
#
pkg_name="cix"
pkg_version="v2.2.0-rc7"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.2.0-rc7.tar.gz"
pkg_sha256="7895b8b1584a58b6cba7b029c7c481bfa69b207dff7f4bce0e802aee4b40d8e5"
