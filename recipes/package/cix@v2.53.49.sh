#
# v2.53.49 -- ADR-0246, plus the call-site fix v2.53.48 died on.
#
...
#
pkg_name="cix"
pkg_version="v2.53.49"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.53.49.tar.gz"
pkg_sha256="d41e4f7c8dea8ed724ca49d387ec6285192415805fad54c95fcfc5f1d24399ca"
