#
# v2.53.55 -- ADR-0246, plus the call-site fix v2.53.48 died on.
#
...
#
pkg_name="cix"
pkg_version="v2.53.55"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.53.55.tar.gz"
pkg_sha256="4660fa13a01dc414b1bd23379348c75bd91b42fd677366161061a98bd805886f"
