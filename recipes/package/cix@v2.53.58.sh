#
# v2.53.58 -- ADR-0246, plus the call-site fix v2.53.48 died on.
#
...
#
pkg_name="cix"
pkg_version="v2.53.58"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.53.58.tar.gz"
pkg_sha256="7b67f4eda96ed4ad5265a43cdab6caefca974e55355e7cd703a7cd2583342b72"
