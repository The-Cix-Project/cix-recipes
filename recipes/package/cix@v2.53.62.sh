#
# v2.53.62 -- ADR-0246, plus the call-site fix v2.53.48 died on.
#
...
#
pkg_name="cix"
pkg_version="v2.53.62"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.53.62.tar.gz"
pkg_sha256="65c892adeb8e02117ba02a7d56795ebd0cc2f179f4ca1482de77771dba909694"
