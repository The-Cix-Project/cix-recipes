#
# v2.53.63 -- ADR-0246, plus the call-site fix v2.53.48 died on.
#
...
#
pkg_name="cix"
pkg_version="v2.53.63"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.53.63.tar.gz"
pkg_sha256="57ea2f5335718fe25f43b1663b96325a69e66c8e9ef41a05474cc025b22cac2f"
