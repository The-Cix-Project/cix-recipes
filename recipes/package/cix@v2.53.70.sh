#
# v2.53.70 -- v2.53.69 did not link, and the fix is a check that would
# have said so.
#
...
#
pkg_name="cix"
pkg_version="v2.53.70"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.53.70.tar.gz"
