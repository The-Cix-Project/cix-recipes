#
# v2.53.72 -- v2.53.69 did not link, and the fix is a check that would
# have said so.
#
...
#
pkg_name="cix"
pkg_version="v2.53.72"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.53.72.tar.gz"
pkg_sha256="0da55d91d40706d1bb73f032cb556cb1d636e88387f8fe47482e5c2846fbfe59"
