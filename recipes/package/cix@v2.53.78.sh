#
# v2.53.78 -- a build output tree is created fresh (ADR-0253), which is
...
#
pkg_name="cix"
pkg_version="v2.53.78"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.53.78.tar.gz"
pkg_sha256="a6e29d0d1ec82f454ec22795844ab49deaa22dd4667cdf77ba928828aaa71966"
