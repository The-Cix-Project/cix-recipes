#
# v2.53.82: ADR-0255 parts 1-4 -- the depth grammar (srcdepth.c), the
# discovery-kind registry (srcupstream.c), the source-policy store
# (srcpolicy.c) and its REST surface (api_srcpolicy.c), plus
# pkg_upstream= on a recipe.
#
# Five new endpoints, so the route count moves 276 -> 281. Nothing
# existing changes behaviour: a package with no pkg_upstream= is pinned,
# which is what every package is today.
#
#
...
#
pkg_name="cix"
pkg_version="v2.53.82"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.53.82.tar.gz"
pkg_sha256="79a98b94a8c678ddf7fb5eb999d022a4e8eff3f8137d37aa9488a5d5287e7503"
pkg_artifact_sha256="c28452dc696fea32ea31fbf27d8eefa72ba4cad5b9b35e4c58912db646a1cfe1"
