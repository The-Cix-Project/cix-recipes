#
# v2.55.23: diagnostic -- echo cix-init's reports so a build log can
# show what a container's supervisor actually did.
#
pkg_name="cix"
pkg_version="v2.55.23"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.55.23.tar.gz"
