#
# v2.55.24: ADR-0260 lands green.
#
# v2.55.23 was the first revision whose selftest passed with services
# in place of cmd, and it carried a one-revision diagnostic echo that
# has now done its job and is gone. What ships here: cix-init as pid 1
# of every container, services[] with after/ready/on_exit, the three
# service endpoints, per-service output attribution, and a container
# stop that is a message on the control socket rather than a signal
# pid 1 can discard.
#
pkg_name="cix"
pkg_version="v2.55.24"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.55.24.tar.gz"
pkg_sha256="89afd25a83e90fe65abb4f8bfbbecdae8dc39da1f92f6f990356c1fa109a4f10"
