#
# v2.57.101: a container can be given a certificate it does not own
#            (#397, ADR-0280)
#
...
#
pkg_name="cix"
pkg_version="v2.57.101"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.101.tar.gz"
pkg_sha256="1fa4c1f93fc5341bc87d6763818bb1c1526bb4fa0be138e5e60fbb36294d0012"
