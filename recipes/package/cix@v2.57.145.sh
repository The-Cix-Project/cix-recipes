#
# v2.57.145: v2.57.144 could not build -- a leftover unused variable in
# logstore.c (#450) failed the gcc lint gate that TCC does not run, and
# it had been latent since v2.57.143. This is v2.57.144's payload with
# that one-line fix: a container sees its own /proc/partitions (#452,
# ADR-0286 tier 1), the dashboard survives blocked localStorage (#453),
# a listener rebinds on a live management-address move (#454), a log
# tail stops once it has enough (#450), git declares zlib (#455), and
# jump gains dns_servers.
#
pkg_name="cix"
pkg_version="v2.57.145"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.145.tar.gz"
pkg_sha256="15bf5ed4fc7f1806f944ec7ed4a962f2aaed6ece565e4e651db79681637df185"
pkg_artifact_sha256="ab4702b8373edded0e52488bc4c62a76cba4f046d48eb0d46ae4c11924376213"
