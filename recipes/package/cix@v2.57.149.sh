#
# v2.57.149: the interactive shell opens with a host-identifying banner
# (#440) -- cixctl build, the Cix build the host runs, project + licence,
# and the host UTC clock, degrading cleanly when the daemon is
# unreachable. Also carries the recipe-bug fixes made this session
# (python zlib/_bz2, byobu runtime deps, bzip2 dev files) in the tree.
#
pkg_name="cix"
pkg_version="v2.57.149"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.149.tar.gz"
pkg_sha256="1f49bddd4e5782e2ef9fee9cae45f1d13732437e170177f84bc4a983974af6dc"
