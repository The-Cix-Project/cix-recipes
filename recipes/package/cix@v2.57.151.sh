#
# v2.57.151: the management address is the single truth; the network
# and its `management` flag are derived, never stored (#436, #441,
# ADR-0287). Collapses the old management-network / is_management /
# bind_ip trio to one input. First build of the daemon changes; the
# selftest gate (apigen route count 304, test_management_address in
# the daemon selftest set) is what proves the redesign compiles and
# binds before this deploys.
#
pkg_name="cix"
pkg_version="v2.57.151"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.151.tar.gz"
pkg_sha256="2cb2674d4af7f0bb69b09b664f1ab4a1512692b1413b7c20c16f5a0c89caadf7"
