#
# v2.57.152: v2.57.151's selftest caught two ADR-0287 gaps (the daemon
# compiled clean). test_management_address: a PUT moving the management
# address off a network's OWN address scheduled that own address for
# removal; test_docindex: ADR-0287 had no docs/adr/README.md row. Both
# fixed; same redesign payload otherwise.
#
pkg_name="cix"
pkg_version="v2.57.152"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.152.tar.gz"
pkg_sha256="b9f40d1a6890d9bc7c81ecf1c639316718b7f756b104b587892759eeed06ff5c"
pkg_artifact_sha256="9d46a7e561026ca512b3db553965980de3996afa4d5ab676edbe36655e819da1"
