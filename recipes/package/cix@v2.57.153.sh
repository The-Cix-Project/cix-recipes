#
# v2.57.153: v2.57.152 built clean and passed selftest but PARKED PID 1
# on 192.168.15.95's first boot -- bootstrap_management_network()
# persisted the migrated management address before daemon_config_init()
# had set its path, so the write hit the read-only root (#436). Fix:
# daemon_config_init before the bootstrap; test_bootorder gates the
# order; a default-route failure no longer parks the box.
#
pkg_name="cix"
pkg_version="v2.57.153"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.153.tar.gz"
pkg_sha256="09a3fe8ad9f2ea33382f8c3348f33e50df8d0a0a001056b2d04f940b2a714d4b"
pkg_artifact_sha256="1a7d8b164caf0e96343ee5fcb817d4e96609f503379268deeddc5059232f9ade"
