#
# v2.57.156: web consistency -- one diskActionEligibility() source for a
# disk's actions (tree right-click menu == detail page), one statusBadge()
# for the status-pill vocabulary (#459), pipeline folded onto the one
# badge widget (#460), plus the web-ux-guidelines design system. Carries
# the v2.57.155 data-directory online-grow daemon change (#94/#249). No
# apigen route change (305).
#
pkg_name="cix"
pkg_version="v2.57.156"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.156.tar.gz"
pkg_sha256="88c587526b404798b7a12ca14e7a92d0ce9fea322cd84def175d53682cebd55b"
pkg_artifact_sha256="e04fbeb37d1792f1a41782d9efa8a3362a0a167ad20050d81b83d47d2b0f7167"
