#
# v2.57.158: redact the repo token from the source-checksum-mismatch
# log line (#461). start_fetch_for()'s "source N hashes to the wrong
# value" error logged the full pkg_source URL, leaking the substituted
# {{REPO_TOKEN}} into the log store; now run through redact_repo_token()
# first. Carries the ADR-0289 hostbuild cache-consumption change.
#
pkg_name="cix"
pkg_version="v2.57.158"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.158.tar.gz"
pkg_sha256="af5739615fd5568b06adc04f163a4a535c9ada3c21565aa680c1500e43362800"
pkg_artifact_sha256="285207d1130b773e6f631208daea851b0cfe8291064601670b89000366e647f7"
