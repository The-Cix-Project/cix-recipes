#
# v2.57.191: the dashboard JavaScript gets a real parser in SELFTESTS
...
#
pkg_name="cix"
pkg_version="v2.57.191"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.191.tar.gz"
pkg_sha256="281e31d906a220a92a08d33da29962eeabd811dfed97c8fce3705965ce46b309"
