#
# v2.57.208: a recipe's format is its filename, and cixd can run one
...
#
pkg_name="cix"
pkg_version="v2.57.208"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.208.tar.gz"
pkg_sha256="8bf5f9fae945ffe017c47aa6d70b7dce55fff9ee6a9763a90144d14c9e29ed4d"
