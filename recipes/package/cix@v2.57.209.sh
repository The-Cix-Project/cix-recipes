#
# v2.57.209: a recipe's format is its filename, and cixd can run one
...
#
pkg_name="cix"
pkg_version="v2.57.209"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.209.tar.gz"
pkg_sha256="1ea6f3300dc8726d65bd131313d0bf2b229e431a5d5dfd0db84e5eb7d509a095"
