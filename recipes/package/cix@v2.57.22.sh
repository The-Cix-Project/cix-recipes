#
# v2.57.22: start procfuse before the containers that need it (#336).
#
# v2.57.21's parent-side log answered the question v2.57.19 could not:
# twelve containers autostarted logging "procfuse dir=(server not
# running)", and the server announced itself one second after the last
# of them. procfuse_start() sat 68 lines below
# containerdef_autostart_all(), under a comment asserting the opposite.
# Nothing failed -- every container took the documented degraded path,
# which is why this looked like a broken bind mount.
#
pkg_name="cix"
pkg_version="v2.57.22"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.22.tar.gz"
pkg_sha256="83bebcffd47de98e6670ad6c1b5f410ce4d66548cbf17f9e6351c9878e44117e"
pkg_artifact_sha256="b9f91b5c379b1426a2aa59d75bbe806901b610b74a8044c4b251934f23df29bc"
