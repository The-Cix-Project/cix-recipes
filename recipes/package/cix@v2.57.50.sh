#
# v2.57.50: an action is attributable to a person (#371, ADR-0271)
#
...
#
pkg_name="cix"
pkg_version="v2.57.50"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.50.tar.gz"
pkg_sha256="ee152e7b74b5f7a469381bf8469375ade2ef17eeab78ef2f0effd285d47c9c6a"
