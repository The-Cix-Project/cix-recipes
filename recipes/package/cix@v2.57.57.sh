#
# v2.57.57: a package must declare every library it links (#389, ADR-0276)
#
...
#
pkg_name="cix"
pkg_version="v2.57.57"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.57.tar.gz"
pkg_sha256="ed8377c2ba30831658d1b7a88aa57e5741e341c7f6f6dbeba35d6efdfb9e122a"
