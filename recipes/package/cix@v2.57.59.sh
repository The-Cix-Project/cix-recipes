#
# v2.57.59: a package must declare every library it links (#389, ADR-0276)
#
...
#
pkg_name="cix"
pkg_version="v2.57.59"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.59.tar.gz"
pkg_sha256="05780c158b64ac2473b62a1f543a6b110a69f7850073eca92b500edf207bf77d"
