#
# v2.57.66: a package must declare every library it links (#389, ADR-0276)
#
...
#
pkg_name="cix"
pkg_version="v2.57.66"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.66.tar.gz"
pkg_sha256="f6db5196533a0cb29c7ccfabb6233ae727d7d4bec9188d472d7d5e1a2cb71321"
