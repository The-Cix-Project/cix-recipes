#
# v2.57.68: a package must declare every library it links (#389, ADR-0276)
#
...
#
pkg_name="cix"
pkg_version="v2.57.68"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.68.tar.gz"
pkg_sha256="a524977d9d6bbd8d18bc5a2af16a346bfe6fd40ece1a815b5e28005658879c74"
