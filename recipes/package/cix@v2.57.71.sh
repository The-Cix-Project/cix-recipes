#
# v2.57.71: a package must declare every library it links (#389, ADR-0276)
#
...
#
pkg_name="cix"
pkg_version="v2.57.71"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.71.tar.gz"
pkg_sha256="e8fc28f14a0c2859245e8bcc199e488ab9a1b38d6a9e40fd76e311ad95b68eeb"
