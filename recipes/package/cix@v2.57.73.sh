#
# v2.57.73: a package must declare every library it links (#389, ADR-0276)
#
...
#
pkg_name="cix"
pkg_version="v2.57.73"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.73.tar.gz"
pkg_sha256="05100452097f9918c2738401288f0b90726903432539550c599abc984d3bf248"
