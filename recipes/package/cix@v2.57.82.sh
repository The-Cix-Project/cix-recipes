#
# v2.57.82: a package must declare every library it links (#389, ADR-0276)
#
...
#
pkg_name="cix"
pkg_version="v2.57.82"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.82.tar.gz"
pkg_sha256="ca31499dc76b0d55ccea583d553533806b1cf9c1d82f26b3ce881c5dadb661f3"
