#
# v2.57.83: a package must declare every library it links (#389, ADR-0276)
#
...
#
pkg_name="cix"
pkg_version="v2.57.83"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.83.tar.gz"
pkg_sha256="f204306a97edeadaba6a3bc432770e567b46da7181b1a0e66f7b71354eeae542"
