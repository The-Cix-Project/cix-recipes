#
# v2.57.87: a package must declare every library it links (#389, ADR-0276)
#
...
#
pkg_name="cix"
pkg_version="v2.57.87"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.87.tar.gz"
pkg_sha256="b87a6c71b14eea87bc194c33c73defcf56b79e95a0d85643865a7391cd4717cc"
