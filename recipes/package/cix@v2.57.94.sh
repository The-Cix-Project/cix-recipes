#
# v2.57.94: a package must declare every library it links (#389, ADR-0276)
#
...
#
pkg_name="cix"
pkg_version="v2.57.94"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.94.tar.gz"
pkg_sha256="4f1e3d3d0531ca032530ffec8f0c8d6c15403981d3d95a8ad7e6d5655d3df80d"
