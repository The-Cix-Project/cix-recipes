#
# v2.57.98: a package must declare every library it links (#389, ADR-0276)
#
...
#
pkg_name="cix"
pkg_version="v2.57.98"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.98.tar.gz"
pkg_sha256="a9eed8ac1cfe0f06409541b652ccc5084d13dedc1f63193f7dd69bdb1c86c459"
