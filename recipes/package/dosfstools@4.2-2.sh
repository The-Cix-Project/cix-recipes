...
pkg_build_depends="bash coreutils make tcc linux-headers sed grep gawk binutils pkgconf findutils diffutils"
pkg_changelog="4.2-2: libc-dev retired; linux-headers declared for the kernel uapi headers glibc's own limits.h needs (#187)"
