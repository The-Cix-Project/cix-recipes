...
pkg_artifact_sha256="da6f649ec7674e0b9bbe9429e5edf5473ab336e2a84ec6a9bfbe1830c52c243a"
...
pkg_toolchain="gcc"
pkg_toolchain_reason="needs re-measurement: recorded as a __thread parsing gap, which tcc 0.9.28rc-10 no longer has (#222) -- the real current blocker has not been measured since the compiler changed"
...
pkg_changelog="0.192-12: declare pkg_toolchain=gcc and its reason (#222, ADR-0226)"
