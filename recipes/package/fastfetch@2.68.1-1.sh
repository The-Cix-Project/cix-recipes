...
pkg_changelog="2.68.1-1: first packaging, and the first CMake-only package here. Ships the Cix ASCII logo, which is not upstream because fastfetch's Logo Request template requires a public repo and a downloadable ISO."
