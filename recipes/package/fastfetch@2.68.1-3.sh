...
pkg_changelog="2.68.1-3: installs /etc/fastfetch/config.jsonc so the shipped Cix logo is the DEFAULT. Revision 2 shipped the logo file but nothing selected it: ID=cix makes fastfetch look for a built-in named cix, there is none, and it drew the generic Tux beside a correct \"OS: Cix\". No change to the logo itself or to the binary."
