...
# With it set, an install fetches <artifact base_url>/flex-2.6.4-4.tar.gz
...
pkg_build_depends="tcc make linux-headers bash coreutils sed grep gawk binutils m4"
pkg_changelog="2.6.4-5: libc-dev retired; linux-headers declared for the kernel uapi headers glibc's own limits.h needs (#187)"
