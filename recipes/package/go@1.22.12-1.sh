#
# go -- stage 4 of the bootstrap (#261).
#
...
#
pkg_name="go"
pkg_version="1.22.12-1"
pkg_source="https://dl.google.com/go/go1.22.12.src.tar.gz"
pkg_sha256="012a7e1f37f362c0918c1dfa3334458ac2da1628c4b9cf4d9ca02db986e17d71"
pkg_depends=""
#
...
pkg_build() {
	...
	*go1.2[0-9]*) ;;
	*)
		echo "go: 1.22 requires a bootstrap of go1.20.6 or later, found: $prev" >&2
		exit 1
		;;
	esac
...
GO
	...
	echo "  compiled and ran a real program -- stage 4 works"
}
