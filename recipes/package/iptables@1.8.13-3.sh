...
pkg_changelog="1.8.13-3: overrides AM_DEPFLAGS, which passes -Wp,-MMD,... that TCC cannot parse. 1.8.13-2: enables the nftables backend, now that libnftnl>=1.2.6 exists as a Cix package (1.2.9); ships libxtables/libip4tc/libip6tc headers and pkg-config files so other packages can build against them; declares libmnl/libnftnl (#206, #207)"
