...
# target had drifted five real tags behind (v1.55.0 through v1.59.0,
# never before deployed) -- v1.59.0 brings kernel-module/sysctl REST
...
pkg_name="kanxeo"
pkg_version="v1.59.0"
pkg_source="https://osakka:REPLACE_WITH_REAL_TOKEN@git.home.arpa/api/v1/repos/itdlabs/kanxeo/archive/v1.59.0.tar.gz"
