...
# load-bearing.
#
pkg_build_depends="bash bc binutils bison bzip2 coreutils diffutils elfutils findutils flex gawk gcc glibc grep gzip kmod m4 make openssl sed tar wireless-regdb xz zlib"
#
