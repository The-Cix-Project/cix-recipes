...
pkg_build() {
	...
	#
	sed -i 's/__attribute__((constructor (300)))/__attribute__((constructor))/' libcap/cap_alloc.c
	sed -i 's/__attribute__((destructor  (300)))/__attribute__((destructor))/' libcap/cap_text.c
	#
