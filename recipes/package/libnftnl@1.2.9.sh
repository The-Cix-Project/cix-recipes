...
pkg_changelog="1.2.9: first packaging -- unblocks iptables, and restores the nftables/firewall features keepalived lost when it stopped building against an ambient Debian libnftnl (#206, #207)"
