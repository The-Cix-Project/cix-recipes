...
pkg_changelog="3.11.0: first packaging -- unblocks iw, hostapd and keepalived, none of which could be rebuilt without netlink development files (#207)"
...
pkg_build() {
	...
	if grep -rq -- '--version-script' --include=Makefile .; then
