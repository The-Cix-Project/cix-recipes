...
pkg_changelog="1.4.20-3: tell configure the POSIX-2024 spawn addchdir name is present, so gnulib stops redeclaring it over glibc 2.44's header alias (#198); gate reads lib/Makefile, which configure actually writes"
