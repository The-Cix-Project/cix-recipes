...
pkg_changelog="1.4.20-4: correct an upstream gnulib typo in obstack.h's non-GCC obstack_free -- OBSTACK_CPTR for _OBSTACK_CPTR, unreachable under GCC and fatal under TCC (#198)"
