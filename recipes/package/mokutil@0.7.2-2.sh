...
pkg_build_depends="bash coreutils make tcc libc-dev binutils autoconf automake m4 pkgconf sed grep gawk findutils diffutils efivar keyutils libxcrypt openssl"
