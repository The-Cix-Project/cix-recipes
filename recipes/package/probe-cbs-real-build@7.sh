...
pkg_depends=""
pkg_changelog="7: re-run against commit 0a5313f6 with nothing softened -- symlinks intact, cache-only, CBS own zstd.cbs verbatim, no env CC binding. Revisions 1-6 found five distinct failures; this checks the four the commit claims to fix."
