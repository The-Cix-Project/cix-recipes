...
# v0.1.50 gitea archive from the box, for cbs@v0.1.50-1.
#
...
pkg_version="1"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix-build-system/archive/v0.1.50.tar.gz"
...
pkg_changelog="1: learns the cix-build-system v0.1.50 archive's sha256 from the box's own fetch log, for cbs@v0.1.50-1."
