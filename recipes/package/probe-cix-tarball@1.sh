...
pkg_changelog="1: learns a gitea archive's sha256 from the box's own fetch log rather than downloading it in the dev sandbox, which the sandbox rule forbids."
