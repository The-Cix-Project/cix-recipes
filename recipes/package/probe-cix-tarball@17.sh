...
pkg_version="17"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.252.tar.gz"
...
pkg_changelog="17: the cix v2.57.252 archive. 1: learns a gitea archive's sha256 from the box's own fetch log rather than downloading it in the dev sandbox, which the sandbox rule forbids."
