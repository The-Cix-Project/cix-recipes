...
pkg_changelog="3: points at cix v2.57.244, for the release recipe. 2: points at cix-build-system v0.1.34, to learn its archive digest for the cbs recipe. 1: learns a gitea archive's sha256 from the box's own fetch log rather than downloading it in the dev sandbox, which the sandbox rule forbids."
