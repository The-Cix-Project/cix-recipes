...
pkg_version="32"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix-recipes/archive/bd2c3d8314cac560febe2f3c1b1258a83090d5c7.tar.gz"
...
pkg_changelog="32: the cix-recipes archive at bd2c3d83, for probe-cix-testreport to pin. 1: learns an archive sha256 from the box own fetch log rather than downloading it in the dev sandbox, which the sandbox rule forbids."
