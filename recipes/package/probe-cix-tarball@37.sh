...
pkg_version="37"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.272.tar.gz"
...
pkg_changelog="37: the cix v2.57.272 archive. 1: learns an archive sha256 from the box own fetch log rather than downloading it in the dev sandbox, which the sandbox rule forbids."
