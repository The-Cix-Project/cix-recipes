...
pkg_version="38"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.273.tar.gz"
...
pkg_changelog="38: the cix v2.57.273 archive. 1: learns an archive sha256 from the box own fetch log rather than downloading it in the dev sandbox, which the sandbox rule forbids."
