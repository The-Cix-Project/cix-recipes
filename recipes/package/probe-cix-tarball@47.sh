...
pkg_version="47"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.281.tar.gz"
...
pkg_changelog="44: the cix v2.57.279 archive. 1: learns an archive sha256 from the box own fetch log rather than downloading it in the dev sandbox, which the sandbox rule forbids."
