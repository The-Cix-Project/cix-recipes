...
pkg_version="9"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.245.tar.gz"
...
pkg_changelog="9: the cix v2.57.245 archive, for cix-tests@v2.57.245. 1: learns a gitea archive's sha256 from the box's own fetch log rather than downloading it in the dev sandbox, which the sandbox rule forbids."
