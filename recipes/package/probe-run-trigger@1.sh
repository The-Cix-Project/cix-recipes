#
# probe-run-trigger 1 -- proves ADR-0272's `trigger` field is right for BOTH
...
pkg_artifact_sha256="e1f2ede89da6e4d1b1d3f205638dfe95a699631c7628d00cc02a29c4973fc306"
...
pkg_install() {
	...
	echo "probe-run-trigger revision 1" > "$PKG_DESTDIR/usr/share/probe-run-trigger/REVISION"
}
