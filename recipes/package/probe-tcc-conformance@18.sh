...
pkg_changelog="18: measure __builtin_bswap*, constructor priority, -Wp comma lists and __STDC_VERSION__ against the shipped compiler, before changing it (#208/#209/#219/#235)"
