...
pkg_changelog="19: same probe as 18, sourced from a URL this host can actually reach -- ftp.gnu.org refuses connections from 192.168.15.95, which is also why gcc cannot be rebuilt right now"
