...
pkg_changelog="5: reduce #216 -- two simultaneously-live locals sharing one stack slot, in the shape found in perl's S_regmatch (a case label of the enclosing switch inside a block that declares locals)"
