...
pkg_changelog="6: v5 stopped after its first test -- the probe programs exit nonzero by design and recipes run under set -e, the same trap probe-tcc-conformance/2 was created to fix. Every run is now guarded."
