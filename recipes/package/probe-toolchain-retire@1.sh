...
pkg_changelog="1: is btrfs-progs' stated gcc reason (TCC cannot parse __thread) still true (#222)"
...
T_EOF
	...
	if ! CC=tcc ./configure --prefix=/usr --disable-documentation --disable-zoned \
	     --disable-python > /run/conf.log 2>&1; then
