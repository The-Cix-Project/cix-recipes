...
pkg_artifact_sha256="7a5e1b9fce86cd6b2a61a1571944c021dbf4fed64763e7f705b1b37d47f0a537"
...
pkg_build_depends="tcc make linux-headers bash coreutils sed grep gawk binutils ncurses"
pkg_changelog="23.7-7: libc-dev retired; linux-headers declared for the kernel uapi headers glibc's own limits.h needs (#187)"
