...
pkg_build_depends="bash coreutils make tcc libc-dev sed grep gawk binutils m4 perl autoconf automake tar gzip findutils diffutils pkgconf gnu-efi libuuid binutils-dev"
