...
#     -I/usr/include/efi
pkg_build_depends="bash coreutils make tcc libc-dev sed grep gawk binutils m4 perl autoconf automake tar gzip getopt findutils diffutils pkgconf gnu-efi libuuid binutils-dev openssl"
...
pkg_build() {
	...
	CC="tcc -D__STDC_NO_VLA__=1" bash lib/ccan.git/tools/create-ccan-tree --build-type=automake lib/ccan \
	...
	CC="tcc -D__STDC_NO_VLA__=1" ./configure --prefix=/usr
