...
# -- installed onto a "kanxeo-builder" image so kanxeo.recipe (ADR-0057)
# has a real tcc to build kanxeod/kanxeoctl with via hostbuild.
#
...
# kanxeod/kanxeoctl, which never pass it) unconditionally defines
