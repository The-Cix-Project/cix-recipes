...
CTOR_EOF
	...
	if ! ./ctorprio_check; then
		echo "tcc: constructor priority is not honoured (#219) -- exit $? encodes 100 + b*10 + a," >&2
		echo "     so 121 means declaration order and 100 means neither ran at all" >&2
		exit 1
	fi
