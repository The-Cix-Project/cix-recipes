...
ATOMIC_EOF
	...
	*)
	...
	#
	# Verify configure recorded it, rather than trusting that the
	# option was spelled the way this version of configure expects.
	#
...
SLOT_EOF
	...
	make clean
	./configure --cc=/run/tcc-stage1/cc --prefix=/usr
	make -j"$(nproc)"
