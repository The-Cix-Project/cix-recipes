...
# gone 45 releases stale and predated thinc-recover.c (ADR-0146)
# entirely, so this same hostbuild round now also builds+stages it,
# alongside thincd/thincctl/web/mkbootroot/thinc-install/
...
pkg_name="thinc"
pkg_version="v1.49.0"
pkg_source="https://osakka:REPLACE_WITH_REAL_TOKEN@git.home.arpa/api/v1/repos/itdlabs/thinc/archive/v1.49.0.tar.gz"
...
#
# build/thinc-recover joins as of this re-pin (ADR-0146): mkinstalleriso
