...
#
# Re-pinned again to v1.86.0 (quality sprint wave, cont.): {{REPO_TOKEN}}
...
pkg_name="thinc"
pkg_version="v1.86.0"
pkg_source="https://osakka:REPLACE_WITH_REAL_TOKEN@git.home.arpa/api/v1/repos/itdlabs/thinc/archive/v1.86.0.tar.gz"
pkg_sha256="78cca197fb0223ed66f283d0306212312ef7e7c75a034927e1c62d08cc9b6ae7"
pkg_depends=""
