...
#
# Re-pinned again to v1.88.0 (quality sprint wave, cont.): {{REPO_TOKEN}}
...
pkg_name="thinc"
pkg_version="v1.88.0"
pkg_source="https://osakka:REPLACE_WITH_REAL_TOKEN@git.home.arpa/api/v1/repos/itdlabs/thinc/archive/v1.88.0.tar.gz"
pkg_sha256="5e483269714061acc14c8750ad32b94bb12251746e5cd34db5da9d2f7255e057"
pkg_depends=""
