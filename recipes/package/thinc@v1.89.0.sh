...
#
# Re-pinned again to v1.89.0 (quality sprint wave, cont.): {{REPO_TOKEN}}
...
pkg_name="thinc"
pkg_version="v1.89.0"
pkg_source="https://osakka:REPLACE_WITH_REAL_TOKEN@git.home.arpa/api/v1/repos/itdlabs/thinc/archive/v1.89.0.tar.gz"
pkg_sha256="2f46da284ef1bd39a4fed23d3bf916d9e95a796447a94e5e19ab88d43f8eaf15"
pkg_depends=""
