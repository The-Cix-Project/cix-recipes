...
#
# Re-pinned again to v1.89.1 (quality sprint wave, cont.): {{REPO_TOKEN}}
...
pkg_name="thinc"
pkg_version="v1.89.1"
pkg_source="https://osakka:REPLACE_WITH_REAL_TOKEN@git.home.arpa/api/v1/repos/itdlabs/thinc/archive/v1.89.1.tar.gz"
pkg_sha256="4d14600d9d0c411b0a17a3fc1814f7eeb7ce04afb85d62ffe496447971b9d476"
pkg_depends=""
