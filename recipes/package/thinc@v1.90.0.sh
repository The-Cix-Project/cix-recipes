...
#
# Re-pinned again to v1.90.0 (quality sprint wave, cont.): {{REPO_TOKEN}}
...
pkg_name="thinc"
pkg_version="v1.90.0"
pkg_source="https://osakka:REPLACE_WITH_REAL_TOKEN@git.home.arpa/api/v1/repos/itdlabs/thinc/archive/v1.90.0.tar.gz"
pkg_sha256="3c720b1c996e26d21d33d32f4833216c80ebad34c6fbb168534a8803e833aae8"
pkg_depends=""
