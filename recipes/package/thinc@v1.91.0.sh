...
#
# Re-pinned again to v1.91.0 (quality sprint wave, cont.): {{REPO_TOKEN}}
...
pkg_name="thinc"
pkg_version="v1.91.0"
pkg_source="https://osakka:REPLACE_WITH_REAL_TOKEN@git.home.arpa/api/v1/repos/itdlabs/thinc/archive/v1.91.0.tar.gz"
pkg_sha256="e047dc3ebf92049ef383b7f8eae6a6df9a455f34a4939c2cdbbc5d05b860f0e2"
pkg_depends=""
