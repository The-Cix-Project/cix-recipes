...
#
# Re-pinned again to v1.92.0 (quality sprint wave, cont.): {{REPO_TOKEN}}
...
pkg_name="thinc"
pkg_version="v1.92.0"
pkg_source="https://osakka:REPLACE_WITH_REAL_TOKEN@git.home.arpa/api/v1/repos/itdlabs/thinc/archive/v1.92.0.tar.gz"
pkg_sha256="9738c5bf62066b2ab89d5d591cfe2c110506ef62aba19163ed71b30b9023b46c"
pkg_depends=""
