...
#
# Re-pinned again to v1.93.0 (quality sprint wave, cont.): {{REPO_TOKEN}}
...
pkg_name="thinc"
pkg_version="v1.93.0"
pkg_source="https://osakka:REPLACE_WITH_REAL_TOKEN@git.home.arpa/api/v1/repos/itdlabs/thinc/archive/v1.93.0.tar.gz"
pkg_sha256="fdfa82916aca8533af97b628698558326cb7f7695b3cb0e71e4822eba09c3e0f"
pkg_depends=""
