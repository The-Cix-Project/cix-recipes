...
#
# Re-pinned again to v1.94.0 (quality sprint wave, cont.): {{REPO_TOKEN}}
...
pkg_name="thinc"
pkg_version="v1.94.0"
pkg_source="https://osakka:REPLACE_WITH_REAL_TOKEN@git.home.arpa/api/v1/repos/itdlabs/thinc/archive/v1.94.0.tar.gz"
pkg_sha256="2416059701bf3a663caf419dc370ac954392a5ebcac9acdb61e5401448e3e117"
pkg_depends=""
