...
#
# Re-pinned again to v1.95.0 (quality sprint wave, cont.): {{REPO_TOKEN}}
...
pkg_name="thinc"
pkg_version="v1.95.0"
pkg_source="https://osakka:REPLACE_WITH_REAL_TOKEN@git.home.arpa/api/v1/repos/itdlabs/thinc/archive/v1.95.0.tar.gz"
pkg_sha256="7eb0a5320b737bed92d90a0ced3979eaac015cfb9f5738b0703c655da27b4d88"
pkg_depends=""
