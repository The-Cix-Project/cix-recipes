...
#
# Re-pinned again to v1.96.0 (quality sprint wave, cont.): {{REPO_TOKEN}}
...
pkg_name="thinc"
pkg_version="v1.96.0"
pkg_source="https://osakka:REPLACE_WITH_REAL_TOKEN@git.home.arpa/api/v1/repos/itdlabs/thinc/archive/v1.96.0.tar.gz"
pkg_sha256="3ba8f2e14efaaa34eb26c71a5684cb474d60b2bb10af7d001004f817b725ca96"
pkg_depends=""
