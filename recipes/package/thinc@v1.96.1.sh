...
#
# Re-pinned again to v1.96.1 (quality sprint wave, cont.): {{REPO_TOKEN}}
...
pkg_name="thinc"
pkg_version="v1.96.1"
pkg_source="https://osakka:REPLACE_WITH_REAL_TOKEN@git.home.arpa/api/v1/repos/itdlabs/thinc/archive/v1.96.1.tar.gz"
pkg_sha256="63b7134031056071b14de1c68191dd2068944e48c3c393e9f3cc571a1dc9b909"
pkg_depends=""
