...
pkg_name="thinc"
pkg_version="v1.99.1"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/thinc/archive/v1.99.1.tar.gz"
pkg_sha256="0109019772cc98409d3c126feab35076617e5d2e0c82b95288b46ca532a43a20"
pkg_depends=""
