...
# gone kanxeo-builder image while sitting installed in three healthy
# ones.
#
...
# from the daemon's own stored repo token (#60, `thincctl pkg repo-
...
pkg_name="thinc"
pkg_version="v1.99.2"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/thinc/archive/v1.99.2.tar.gz"
pkg_sha256="5ea3babac578d256c3fc29123c2cf02ec5862bc7138ad34a54b1b738aab31b40"
pkg_depends=""
