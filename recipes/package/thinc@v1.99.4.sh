...
pkg_name="thinc"
pkg_version="v1.99.4"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/thinc/archive/v1.99.4.tar.gz"
pkg_sha256="d3531adc36f9bfa31a412a294d15ed5880c8d3a617ff28bf013a8cddd8529b6b"
pkg_depends=""
