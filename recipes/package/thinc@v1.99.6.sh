...
pkg_name="thinc"
pkg_version="v1.99.6"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/thinc/archive/v1.99.6.tar.gz"
pkg_sha256="52defca9e286ca8c8a0c9a422c0841efa627a216a392b839971190331a07a6e0"
pkg_depends=""
