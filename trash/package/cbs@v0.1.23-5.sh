...
pkg_build() {
	...
	sh -x ./tests/cli-build-test.sh ./cbs > /run/cli.trace 2>&1; echo "  rc=$?"
	tail -30 /run/cli.trace
	echo "==================== make test"
