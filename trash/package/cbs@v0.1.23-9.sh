...
#
pkg_name="cbs"
pkg_version="v0.1.23-9"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix-build-system/archive/09fc6e9.tar.gz"
pkg_sha256="a69b81f2b309f9094fb09570460d3b3e45c9d92884efc8c4ef617d50ef9d23c4"
...
pkg_build() {
	...
	set +e
	echo "==================== what observe-test.c hardcodes"
	for p in /bin/ls /usr/bin/ls /etc/hosts /bin/sh; do
		printf '  %-14s %s\n' "$p" "$(test -e $p && echo present || echo ABSENT)"
	done
	echo "  /bin contents: $(ls /bin 2>/dev/null | tr '\n' ' ')"
