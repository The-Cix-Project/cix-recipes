...
#
pkg_name="cbs"
pkg_version="v0.1.24-1"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix-build-system/archive/v0.1.24.tar.gz"
pkg_sha256="9babd52cd111b0dd4a20228c7bdccbd7a576b7a16bb7127e4cb4f21308fb36c1"
