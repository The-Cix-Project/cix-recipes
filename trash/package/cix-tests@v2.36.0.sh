...
pkg_name="cix-tests"
pkg_version="v2.36.0"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.36.0.tar.gz http://192.168.15.31:8080/kernel-6.18.40-20-x86_64.tar.gz"
pkg_sha256="a1724fedfe1488cf49e99edce0e38a60f0f66c0a2baaf51d51c427b4a731acf2 1a929babcf2654cc45d9d47197f0a003b6660573cecf9ae0ce930edcf8b6ab4f"
pkg_depends=""
#
