...
pkg_name="cix-tests"
pkg_version="v2.39.0"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.39.0.tar.gz http://192.168.15.31:8080/kernel-6.18.40-20-x86_64.tar.gz"
pkg_sha256="fff2ffc54947b03243b3ba5ab931222c83634f84ddc038551d4e0ffaa1a3aea1 1a929babcf2654cc45d9d47197f0a003b6660573cecf9ae0ce930edcf8b6ab4f"
pkg_depends=""
#
