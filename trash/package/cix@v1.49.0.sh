...
# gone 45 releases stale and predated cix-recover.c (ADR-0146)
# entirely, so this same hostbuild round now also builds+stages it,
# alongside cixd/cixctl/web/mkbootroot/cix-install/
...
pkg_name="cix"
pkg_version="v1.49.0"
pkg_source="https://osakka:REPLACE_WITH_REAL_TOKEN@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v1.49.0.tar.gz"
...
#
# build/cix-recover joins as of this re-pin (ADR-0146): mkinstalleriso
