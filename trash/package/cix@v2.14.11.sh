#
# v2.14.11 -- a btrfs partition can be grown (#163), which needed btrfs-progs
...
#
pkg_name="cix"
pkg_version="v2.14.11"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.14.11.tar.gz"
pkg_sha256="4a273b17413110be180355da7a7c1393f2558de977738a71c75ee64e82fd4769"
