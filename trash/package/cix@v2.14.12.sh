#
# v2.14.12 -- a btrfs partition can be grown (#163), which needed btrfs-progs
...
#
pkg_name="cix"
pkg_version="v2.14.12"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.14.12.tar.gz"
pkg_sha256="5b3ea65f2ea7d1b5b3263473c2cb2f3daf095a9a4f81e9bf3ae95ebbed76e74a"
