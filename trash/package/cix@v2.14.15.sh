#
# v2.14.15 -- a btrfs partition can be grown (#163), which needed btrfs-progs
...
#
pkg_name="cix"
pkg_version="v2.14.15"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.14.15.tar.gz"
pkg_sha256="a22d0be93f3b7a0c8cd913e07815075b8ae417b66e2f34b392bfda0a42b74f92"
