#
# v2.14.9 -- a btrfs partition can be grown (#163), which needed btrfs-progs
...
pkg_name="cix"
pkg_version="v2.14.9"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.14.9.tar.gz"
pkg_sha256="3da2bf81b35dccbfebb35f0f88d666374d6b99cb15736dd6e56e4c454f41d0e9"
