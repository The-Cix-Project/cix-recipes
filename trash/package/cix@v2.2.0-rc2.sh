#
# Re-pinned to v2.2.0-rc2: rc1's registered copy on the target box was
# published with a malformed embedded token (a substitution slip on the
# operator side, not a source change -- rc2 is the same epic head plus
# its own recipe files) and recipe versions are immutable once
# published (ADR-0107), so the fix is this bump, exactly as that rule
# intends.
#
...
#
pkg_name="cix"
pkg_version="v2.2.0-rc2"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.2.0-rc2.tar.gz"
pkg_sha256="c50aae2b4d28ee84b0cd987a8817e49157ec3a3c1668ea00e28dd17f7061c3cb"
#
...
pkg_artifact_sha256="7fcdc9adfe8542cfd2d63a3ed5db6274639cd01b0098a94ca29a72c178745f55"
pkg_depends=""
