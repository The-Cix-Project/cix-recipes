...
#
pkg_name="cix"
pkg_version="v2.2.0-rc4"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.2.0-rc4.tar.gz"
pkg_sha256="5bbee8928599277f543871f929c1713342d8678727f62082ff5b3edff6ab9ff2"
#
