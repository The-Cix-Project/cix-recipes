#
# v2.53.50 -- ADR-0246, plus the call-site fix v2.53.48 died on.
#
...
#
pkg_name="cix"
pkg_version="v2.53.50"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.53.50.tar.gz"
pkg_sha256="2192a4e0bdbba9c09fc444fbf7917e2b001a3ff46dc069a5da8b114558159030"
