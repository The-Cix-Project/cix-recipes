#
# v2.53.51 -- ADR-0246, plus the call-site fix v2.53.48 died on.
#
...
#
pkg_name="cix"
pkg_version="v2.53.51"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.53.51.tar.gz"
pkg_sha256="0f0e5878d3f217da246bf9fd6ecff43a7c3932db19144ca3ad1ccc9f8cdcbcdb"
