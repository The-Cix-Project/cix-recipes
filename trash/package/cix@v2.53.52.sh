#
# v2.53.52 -- ADR-0246, plus the call-site fix v2.53.48 died on.
#
...
#
pkg_name="cix"
pkg_version="v2.53.52"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.53.52.tar.gz"
pkg_sha256="4fde704949f46512b5ad2ea02ba3a0f28be552ddb388dfc96caa2c7274e5d0d2"
