#
# v2.53.53 -- ADR-0246, plus the call-site fix v2.53.48 died on.
#
...
#
pkg_name="cix"
pkg_version="v2.53.53"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.53.53.tar.gz"
pkg_sha256="da43c85fc65c2fca1d7ee177ce411f5a6367c4e944f87d58602b918d47d1b760"
