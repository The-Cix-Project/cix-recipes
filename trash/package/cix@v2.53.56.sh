#
# v2.53.56 -- ADR-0246, plus the call-site fix v2.53.48 died on.
#
...
#
pkg_name="cix"
pkg_version="v2.53.56"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.53.56.tar.gz"
pkg_sha256="5f829a5c2aecb2829a76e6e8e7adfc0684834246dd9c775be222d45cc25863c8"
