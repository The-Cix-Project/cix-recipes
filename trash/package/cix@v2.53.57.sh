#
# v2.53.57 -- ADR-0246, plus the call-site fix v2.53.48 died on.
#
...
#
pkg_name="cix"
pkg_version="v2.53.57"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.53.57.tar.gz"
pkg_sha256="c32b2996d86cc7b91c3c45eb1cce04615bf4ba32f96da58545515910eed6b2ab"
