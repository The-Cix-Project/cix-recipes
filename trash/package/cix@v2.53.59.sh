#
# v2.53.59 -- ADR-0246, plus the call-site fix v2.53.48 died on.
#
...
#
pkg_name="cix"
pkg_version="v2.53.59"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.53.59.tar.gz"
pkg_sha256="653b463695e1e1a1413c9077e1e49987d11eeec1233ef027002b1dc62f01879b"
