#
# v2.53.73 -- v2.53.69 did not link, and the fix is a check that would
# have said so.
#
...
#
pkg_name="cix"
pkg_version="v2.53.73"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.53.73.tar.gz"
pkg_sha256="370eaef3d6489ea94e4c602a388e3d9ba47ef7c5f8cb46b4fdc566347afce43d"
