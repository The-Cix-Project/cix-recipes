#
# v2.57.102: a container can be given a certificate it does not own
#            (#397, ADR-0280)
#
...
#
pkg_name="cix"
pkg_version="v2.57.102"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.102.tar.gz"
pkg_sha256="48ccabb165443fa8bbd5f2fae6b4f025d4f8bb78bfb438e217c2c355d70a2874"
