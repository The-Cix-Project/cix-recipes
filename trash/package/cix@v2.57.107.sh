#
# v2.57.107: the CA can leave the box, encrypted, and come back
#            (#415, ADR-0281)
#
...
#
pkg_name="cix"
pkg_version="v2.57.107"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.107.tar.gz"
pkg_sha256="7df8b11f744a26da0f0bbb334d84a38ca1b4321f8d34f82329513baf8f9817c9"
