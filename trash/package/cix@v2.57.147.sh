#
# v2.57.147: forked children get their own command_line too (#456). The
# comm names shipped in v2.57.146; this fixes the longer
# /proc/<pid>/cmdline, inherited from the parent across a fork -- the
# procfuse server and watchdog reported "/bin/cixd --init-mode ..." and
# cix-init showed its raw fd arguments. proctitle.c rewrites the argv
# area in place: "cixd [procfuse]", "cixd [watchdog]", and
# "cix-init:<container>".
#
pkg_name="cix"
pkg_version="v2.57.147"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.147.tar.gz"
pkg_sha256="02c60be638814bc1adf2cd39c32c24ba2d5a9f5918265cf915b6b93c0bcae006"
pkg_artifact_sha256="bc4a169895ccb63e77117a8797c5a131667d2112af7ddafdaef8ceb6cf5c8ea4"
