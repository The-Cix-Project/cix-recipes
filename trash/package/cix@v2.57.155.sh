#
# v2.57.155: grow the data-directory partition online, in place (#94,
# #249, ADR-0288). A mounted btrfs grows on its live mountpoint (btrfs
# filesystem resize max), the one way to extend /var/lib/cix; every
# resize's table grow moves to the append path's --no-tell-kernel +
# BLKPG_RESIZE_PARTITION so it works on a busy disk. Idempotent on
# retry. diskpart_resize_target gated in test_diskpart; apigen route
# count unchanged (305).
#
pkg_name="cix"
pkg_version="v2.57.155"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.155.tar.gz"
pkg_sha256="67e71d5138ab8efdce40ef9e8a8322b16d999b23553cc2a8ab9832c1fae75956"
pkg_artifact_sha256="93bfa6638fd4fda4493a8eadfced3d2e59f9f42ff9263e28218e84e39da9ed7d"
