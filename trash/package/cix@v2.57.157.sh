#
# v2.57.157: a hostbuild package is consumed from the cache like any
# other (ADR-0289). start_fetch_for() no longer excludes a hostbuild
# from the local build-artifact cache read (cache_hit = pkg_cache_has,
# was !is_hostbuild && ...); ADR-0122's exclusion reasoned about the
# harvested OUTPUT but sat on the read. The remote signed-artifact
# tier was never hostbuild-gated -- proven live (hostbuild cix
# v2.57.155 upgrade fetched in 3s, no build). No apigen route change
# (305). Carries the v2.57.156 web-consistency work.
#
pkg_name="cix"
pkg_version="v2.57.157"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.157.tar.gz"
pkg_sha256="acc2105f4630dff5bbe0595b40c872a60b4291bda75f2abfeeda65134c8c1ea0"
pkg_artifact_sha256="f19ebb9356f005383d97737d3fa45883c81591999742be734ab16d1fd18bcbb5"
