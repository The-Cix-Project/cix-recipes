#
# v2.57.211: a recipe's format is its filename, and cixd can run one
...
#
pkg_name="cix"
pkg_version="v2.57.211"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.211.tar.gz"
pkg_sha256="9931045718a9a82c240ae9c2e232f2391e9cbd45a56a2e3ff6d5563e3bf50cac"
