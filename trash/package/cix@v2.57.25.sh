#
# v2.57.25: v2.57.24's cpu-cap fix, plus a diagnostic that can finally
# name why test_console_exec fails (#331).
#
# v2.57.24 built clean apart from test_console_exec -- its fourth
# intermittent failure today, and the fourth to report "read failed or
# peer closed", which is one message for two opposite faults. read_full()
# folded a socket TIMEOUT and a CLOSED PEER into the same -1. The failure
# now says which, and how long it waited, so the next occurrence decides
# it instead of prompting a fifth investigation.
#
pkg_name="cix"
pkg_version="v2.57.25"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.25.tar.gz"
pkg_sha256="1ee0f2da6944002ebbed82d880279245aa59bfec11a6be7ca528beed5da99e3b"
pkg_artifact_sha256="83d2c558d8e88b5a8dc853f8eb0b33cef79271f3eb2395791f4f6befea5791da"
