#
# v2.57.29: v2.57.28's three fixes, plus the dashboard console.
#
# The console showed the PREVIOUS container's output after a switch: a
# closing WebSocket still delivers buffered frames and fires onclose
# afterwards, and every handler wrote through the module-level terminal
# and the shared status element. Sessions are numbered now.
#
# The terminal fills the content area instead of a fixed 420px -- rows
# the remote program can actually use -- and opens in its own window at
# #console-popout/<container>/<console>.
#
# v2.57.28 itself never deployed: it failed the gate on test_cix_init,
# whose restart bound asserted 1.5s against a delay cix-init computes
# from a truncating second counter (#361).
#
pkg_name="cix"
pkg_version="v2.57.29"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.29.tar.gz"
pkg_sha256="4df14184ecfec151deff0be951ea11f2ad15010f1d7e82fab61f1a32dd77411b"
pkg_artifact_sha256="ee72d69df6889f82cbca52b9d7e79a37e5478560352d92eb3c0ff53a2719a90c"
