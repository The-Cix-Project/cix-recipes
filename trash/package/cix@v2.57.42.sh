#
# v2.57.42: a deployment waits for its image (#371, ADR-0270)
#
...
#
pkg_name="cix"
pkg_version="v2.57.42"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.42.tar.gz"
pkg_sha256="e689ed128ce81e3fc713f8bf94d3701003db6fa65ed29008aa0f6484fd22351d"
