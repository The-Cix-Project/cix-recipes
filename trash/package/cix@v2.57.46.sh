#
# v2.57.46: an action is attributable to a person (#371, ADR-0271)
#
...
#
pkg_name="cix"
pkg_version="v2.57.46"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.46.tar.gz"
pkg_sha256="0ea29a924c5037c0fa04dc4c4658b2f0efc70dbbca6c962584f68a4333ce1706"
