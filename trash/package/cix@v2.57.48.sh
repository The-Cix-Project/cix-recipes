#
# v2.57.48: an action is attributable to a person (#371, ADR-0271)
#
...
#
pkg_name="cix"
pkg_version="v2.57.48"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.48.tar.gz"
pkg_sha256="d5bbe13458560d5e5202cf901a70e59bae4c32267ec70cbee8d8ad398f80d945"
