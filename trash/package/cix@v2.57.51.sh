#
# v2.57.51: an action is attributable to a person (#371, ADR-0271)
#
...
#
pkg_name="cix"
pkg_version="v2.57.51"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.51.tar.gz"
pkg_sha256="a23d7676ee72dec460c8b2fbabcfa2b2bddbd76a4f7d02aaa57bc71c4f46f96f"
