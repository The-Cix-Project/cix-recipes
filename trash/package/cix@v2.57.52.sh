#
# v2.57.52: an action is attributable to a person (#371, ADR-0271)
#
...
#
pkg_name="cix"
pkg_version="v2.57.52"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.52.tar.gz"
pkg_sha256="4575135cba37dd9277ff1e12010d80c881961ebb5b881317f12ac8bed9038ab3"
