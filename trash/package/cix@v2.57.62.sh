#
# v2.57.62: a package must declare every library it links (#389, ADR-0276)
#
...
#
pkg_name="cix"
pkg_version="v2.57.62"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.62.tar.gz"
pkg_sha256="1fd8b0f8141e6bcd5e68bdd38ea2a93c5678f0cc6549ab805961aeb230854068"
