#
# v2.57.64: a package must declare every library it links (#389, ADR-0276)
#
...
#
pkg_name="cix"
pkg_version="v2.57.64"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.64.tar.gz"
pkg_sha256="bfae1f87c693c51b17f972509c6ab9485feffa9fccc9b6c307b8ed03f0c92c64"
