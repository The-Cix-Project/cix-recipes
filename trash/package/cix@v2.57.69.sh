#
# v2.57.69: a package must declare every library it links (#389, ADR-0276)
#
...
#
pkg_name="cix"
pkg_version="v2.57.69"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.69.tar.gz"
pkg_sha256="0f44b0ac93715ff2e9f359cb7895933bd016b3a9dad2890c5bb3703f9fc426a2"
