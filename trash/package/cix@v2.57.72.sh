#
# v2.57.72: a package must declare every library it links (#389, ADR-0276)
#
...
#
pkg_name="cix"
pkg_version="v2.57.72"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.72.tar.gz"
pkg_sha256="a6a759fd431cfd38c22f445eb0d31833c9bf69ec504c4274e67672fb85ac8dcf"
