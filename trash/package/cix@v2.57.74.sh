#
# v2.57.74: a package must declare every library it links (#389, ADR-0276)
#
...
#
pkg_name="cix"
pkg_version="v2.57.74"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.74.tar.gz"
pkg_sha256="946bc26e9932290e01d2d503e332bc83132eeff98f67496708f52ab30367fa2c"
