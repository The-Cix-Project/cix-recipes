#
# v2.57.75: a package must declare every library it links (#389, ADR-0276)
#
...
#
pkg_name="cix"
pkg_version="v2.57.75"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.75.tar.gz"
pkg_sha256="1a2fee8ed25cfa84b3227c00da71577b769bbd5db794028df39e3c65de360a4d"
