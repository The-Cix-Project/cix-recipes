#
# v2.57.76: a package must declare every library it links (#389, ADR-0276)
#
...
#
pkg_name="cix"
pkg_version="v2.57.76"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.76.tar.gz"
pkg_sha256="ad4496068a6606f8988a7972c2963cda726c27919cc8d8e85f76192cd7d4b60a"
