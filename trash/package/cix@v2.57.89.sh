#
# v2.57.89: a package must declare every library it links (#389, ADR-0276)
#
...
#
pkg_name="cix"
pkg_version="v2.57.89"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.89.tar.gz"
pkg_sha256="84ecc8f4d6b4d5549ae66b48c0a0ac8370973b34e2719dee11b2b73b31be2d0a"
