#
# v2.57.92: a package must declare every library it links (#389, ADR-0276)
#
...
#
pkg_name="cix"
pkg_version="v2.57.92"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.92.tar.gz"
pkg_sha256="9028366b4f6bfb71e74079e22332d7057b23dc5ef49cd522a5bf42fa0b2f11e3"
