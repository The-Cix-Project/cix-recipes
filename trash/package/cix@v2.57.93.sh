#
# v2.57.93: a package must declare every library it links (#389, ADR-0276)
#
...
#
pkg_name="cix"
pkg_version="v2.57.93"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.93.tar.gz"
pkg_sha256="f2be88c5b865e83bb9197d92cb8b12767e8174de4baa2c4c61fd2edeae877082"
