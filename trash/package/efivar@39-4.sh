...
pkg_changelog="39-4: libc-dev retired; linux-headers declared for the kernel uapi headers glibc's own limits.h needs (#187)"
...
# exist.
pkg_build() {
	make CC=/usr/bin/gcc ENABLE_DOCS=0 LIBDIR=/lib/x86_64-linux-gnu -j"$(nproc)"
}
