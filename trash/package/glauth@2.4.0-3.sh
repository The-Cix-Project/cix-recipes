...
pkg_depends=""
pkg_toolchain="gcc"
pkg_toolchain_reason="build system requires GCC internals: cgo: mattn/go-sqlite3 compiles SQLite through cmd/cgo, which TCC cannot drive (#31)"
pkg_changelog="2.4.0-3: declare pkg_toolchain=gcc and its reason (#222, ADR-0226)"
