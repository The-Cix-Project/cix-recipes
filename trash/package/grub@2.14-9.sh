...
pkg_toolchain="gcc"
pkg_toolchain_reason="build system requires GCC internals: GRUB's own build refuses a compiler it does not recognise, on its own say-so rather than a judgement call"
...
pkg_changelog="2.14-9: declare pkg_toolchain=gcc and its reason (#222, ADR-0226)"
