...
pkg_version="7.2.3-4"
pkg_source="https://cdn.kernel.org/pub/linux/kernel/v7.x/linux-7.2.3.tar.xz https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/raw/image/kernel/qemu-part1.config?ref=e3ee2c508a9dbb2b34158380765f0716602c4a6f"
pkg_sha256="8ba259e8e7b13ec6ef0941c8a39ad90b24bd4a4d6c0010ba6bafb794550ecd03 7fb4e9151d53a6873153288d98de8f29ce62e0517a3cc8f4e4ff1e4c6144b525"
pkg_depends=""
#
...
EOF
	...
	for sym in CONFIG_TMPFS_XATTR CONFIG_KSM CONFIG_ADVISE_SYSCALLS \
	           ...
	           CONFIG_SCSI_HPSA CONFIG_DEVTMPFS CONFIG_DEVTMPFS_MOUNT; do
