...
pkg_artifact_sha256="06cd59a74a759a395fca864f6f955f8981738fd46443e32b87534e403db61f78"
pkg_depends=""
...
pkg_changelog="4.4.36-5: libc-dev retired; linux-headers declared for the kernel uapi headers glibc's own limits.h needs (#187)"
...
pkg_build() {
	...
	CC=/usr/bin/gcc ./configure --prefix=/usr --libdir=/lib/x86_64-linux-gnu \
...
pkg_install() {
	...
	test -e "$PKG_DESTDIR/lib/x86_64-linux-gnu/libcrypt.so.2"
