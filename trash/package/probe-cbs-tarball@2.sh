...
# v0.1.52 gitea archive from the box, for cbs@v0.1.52-1.
#
...
pkg_version="2"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix-build-system/archive/v0.1.52.tar.gz"
...
pkg_changelog="2: the v0.1.52 archive, for cbs@v0.1.52-1. 1: learns the cix-build-system v0.1.50 archive's sha256 from the box's own fetch log, for cbs@v0.1.50-1."
