...
pkg_version="4"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix-build-system/archive/v0.1.55.tar.gz"
...
pkg_changelog="4: the v0.1.55 archive, for cbs@v0.1.55-1. 3: the v0.1.53 archive, for cbs@v0.1.53-1. 2: the v0.1.52 archive, for cbs@v0.1.52-1. 1: learns the cix-build-system v0.1.50 archive's sha256 from the box's own fetch log, for cbs@v0.1.50-1."
