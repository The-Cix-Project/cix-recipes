...
pkg_depends=""
pkg_build_depends="bash coreutils grep go tcc libc-dev"
pkg_changelog="1: first probe. Re-measures glauth's gcc requirement against the current compiler, per ADR-0226's rule that a toolchain reason is a dated measurement rather than a verdict."
