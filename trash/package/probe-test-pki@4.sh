...
pkg_version="4"
pkg_source="https://osakka:{{REPO_TOKEN}}@git.home.arpa/api/v1/repos/itdlabs/cix/archive/v2.57.118.tar.gz"
pkg_sha256="a5a12f7ddd1ae75d150c9760a969e95d3c625f3e77a067cad54b2dc11a23f3b2"
...
pkg_changelog="4: probe 3 narrowed it to four container scenarios all returning a bare 500. test_pki now prints the servers own reason, so this run says WHY container creation fails in a build container -- which decides whether test_pki can be gated whole or has to be split (#417)"
