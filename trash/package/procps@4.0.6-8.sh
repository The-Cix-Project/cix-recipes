...
#
pkg_build_depends="tcc make linux-headers bash coreutils sed grep gawk binutils findutils diffutils autoconf automake libtool m4 perl ncurses pkgconf gettext"
