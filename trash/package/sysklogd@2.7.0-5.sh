...
pkg_name="sysklogd"
pkg_version="2.7.0-5"
pkg_changelog="2.7.0-5: rebuild against tcc 0.9.28rc-10, which emits PT_GNU_STACK (#228). The artifact approval is dropped because those bytes came from rc-9."
